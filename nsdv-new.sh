...
function fun_output(){
	...
	then
		...
		read new_lct_out 
		echo $new_lct_out >> ./lcte_file.txt
...
function fun_yt_dlp(){
yt-dlp $skp $Format_list $Format_video $pl_s $S_item $pl_e $E_item $List_subs $Write_sub $Sub_lang $lng $write_auto_sub $lcte $url_v $v_url
}
